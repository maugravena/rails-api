...
ActiveRecord::Schema[7.1].define(version: 2024_03_06_183217) do
  ...
  create_table "policies", primary_key: "policy_id", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
